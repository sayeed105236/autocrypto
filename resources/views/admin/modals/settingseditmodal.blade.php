          ...
          <form id="jquery-val-form" action="{{route('system-update')}}" method="post">
            ...
            <input type="hidden" name="id" value="{{$settings->id}}">
              ...
              <div class="col-md-12">
                ...
                <input type="round" value="{{($settings->level_1)}}" name="level_1" class="form-control" required>
              </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                <label for="inputLastName" class="form-label">Level 2 Bonus (%)</label>
                <input type="round" value="{{($settings->level_2)}}" name="level_2" class="form-control" required>
              </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                <label for="inputLastName" class="form-label">Level 3 Bonus (%)</label>
                <input type="round" value="{{($settings->level_3)}}" name="level_3" class="form-control" required>
              </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                <label for="inputLastName" class="form-label">Level 4 Bonus (%)</label>
                <input type="round" value="{{($settings->level_4)}}" name="level_4" class="form-control" required>
              </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                <label for="inputLastName" class="form-label">Level 5 Bonus (%)</label>
                <input type="round" value="{{($settings->level_5)}}" name="level_5" class="form-control" required>
              </div>
              </div>
