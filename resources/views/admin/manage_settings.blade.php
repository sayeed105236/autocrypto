            ...
            <div class="card-body p-5">
              ...
              <form class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"  value="{{($settings->level_1)}}" disabled class="form-control" id="inputLastName">
                </div>
                <div class="col-md-6">
                  <label for="inputLastName" class="form-label">Level 2 Bonus (%)</label>
                  <input type="text"  value="{{($settings->level_2)}}" disabled class="form-control" id="inputLastName">
                </div>
                <div class="col-md-6">
                  <label for="inputLastName" class="form-label">Level 3 Bonus (%)</label>
                  <input type="text"  value="{{($settings->level_3)}}" disabled class="form-control" id="inputLastName">
                </div>
                <div class="col-md-6">
                  <label for="inputLastName" class="form-label">Level 4 Bonus (%)</label>
                  <input type="text"  value="{{($settings->level_4)}}" disabled class="form-control" id="inputLastName">
                </div>
                <div class="col-md-6">
                  <label for="inputLastName" class="form-label">Level 5 Bonus (%)</label>
                  <input type="text"  value="{{($settings->level_5)}}" disabled class="form-control" id="inputLastName">
                </div>
