...
Route::get('/home/activation-package/{id}', [HomeController::class,'Activate'])->name('activation')->middleware('auth');
Route::post('/home/package/store', [HomeController::class,'ActivatePackage'])->name('buy-package')->middleware('auth');
...
//admin add packages
Route::get('/admin/manage-package', [PackageController::class,'Manage'])->name('package-manage')->middleware('authadmin');
Route::post('/admin/package/store', [PackageController::class,'StorePackage'])->name('store-package')->middleware('authadmin');
Route::post('/admin/package/update', [PackageController::class,'UpdatePackage'])->name('package-update')->middleware('authadmin');
Route::get('/admin/package/delete/{id}', [PackageController::class,'DeletePackage'])->middleware('authadmin');

//admin add daily bonus
Route::get('/admin/manage-daily-bonus', [HomeController::class,'daily_bonus'])->name('manage-daily-bonus')->middleware('authadmin');
Route::post('/admin/daily-bonus/store', [HomeController::class,'DailyBonusStore'])->name('daily-bonus-store')->middleware('authadmin');
